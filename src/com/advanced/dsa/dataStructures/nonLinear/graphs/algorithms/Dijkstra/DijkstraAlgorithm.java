package com.advanced.dsa.dataStructures.nonLinear.graphs.algorithms.Dijkstra;
...
public class DijkstraAlgorithm {
    public static  List<Integer> dijkstra(int V , List<List<Pair>> adj, int S){
        ...
        // initially distance array has all the large value
    ...
    public static void main(String[] args) {
        ...
        for (int i=0;i<V; i++){
            adj.add(new ArrayList<>()); // adding empty array for storage
        }
        ...
        System.out.println("Shortest diatance from node:"+S+" : ");
        for (int i=0;i<V;i++){
